...
class SpotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create spot" do
    assert_difference('Spot.count') do
      post spots_url, params: { spot: { img: @spot.img, lat: @spot.lat, lng: @spot.lng, name: @spot.name, tsukkomi: @spot.tsukkomi } }
    end
  ...
  test "should update spot" do
    patch spot_url(@spot), params: { spot: { img: @spot.img, lat: @spot.lat, lng: @spot.lng, name: @spot.name, tsukkomi: @spot.tsukkomi } }
